...
import AppSidebarRight from "@/components-App/AppSidebar/AppSidebarRight.vue";
...
const postShow = async (data: ShowType, files?: MyFileInfo[]) => {
  ...
  if (CreateYouShowRes.code == 200) {
    ...
    data.userAvatarURL = appStore.fileBaseURL + data.userAvatarURL;
